...
const Comment = ({ comment }: Props) => {
  ...
  return (
    <div className="w-full px-5 py-2 rounded-md border-x-2 border-highlight-700 dark:border-highlight-500 bg-primary-100 dark:bg-primary-800 dark:text-white">
      <p>{comment.body}</p>
